 ...
 * ------------------------
 * Easy:
 *  - [x] Show date of summary data (API provides Date field)
 *  - [x] Format numbers with abbreviation utility
 *  - [x] Add refresh button
 *  - [x] Add note/link about data source & potential delays
 * Medium:
 *  - [x] Country search input (filter dropdown)
 *  - [x] Sort countries (Total Confirmed, New Confirmed, Deaths)
 *  - [ ] Persist last selected country
 *  - [x] Basic trend chart (cases over time) for selected country
 * Advanced:
...
export default function Covid() {
  ...
  const filteredCountries = countries
    ...
    .sort((a, b) => {
      ...
      if (sortBy === 'todayCases') return b.todayCases - a.todayCases;
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {countries.length > 0 && (
            <>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                      ...
                      <div className="bg-green-50 p-4 rounded-lg">
                        ...
                        <p className="text-2xl font-bold text-green-600">{formatNumber(selected.recovered || 0)}</p>
                      </div>
              ...
              {/* Legacy CountryTrendChart for backwards compatibility */}
